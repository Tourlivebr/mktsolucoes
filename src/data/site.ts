...
export const siteData = {
  company: {
    ...
    fullAddress: "R. Cassino, 119 - Ipanema, Porto Alegre, RS - Brasil"
  },

  banners: [
    {
      id: 1,
      title: "Tecnologia que transforma negócios em experiências digitais",
    ...
    },
    {
      ...
      subtitle: "Sites Comerciais com estratégias de conversão",
      cta: "Como funciona",
    ...
    {
      id: 3,
      title: "Tudo sobre seu negócio em um só lugar",
      subtitle: "Portais e Plataformas Digitais",
      cta: "Solicite",
  ...
  benefits: [
    {
      id: 1,
      title: "Conectando Pessoas, Negócios e Tecnologia",
      description: "Unimos marketing digital e tecnologia interativa para conectar empresas e clientes.",
      icon: "🚀"
    },
    {
      id: 2,
      title: "Soluções Inteligentes para seu Negócio",
      description: "Unimos automação, tecnologia e marketing para dar mais visibilidade ao seu negócio.",
      icon: "📊"
    },
    {
      id: 3,
